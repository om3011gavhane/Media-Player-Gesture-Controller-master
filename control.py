...
class Control:
    def __init__(self, media_path): #media path : videop path
        self.mp_drawing = mp.solutions.drawing_utils
        self.mp_hands = mp.solutions.hands
        with open('gesture_recognition_model.pkl', 'rb') as f: #pkl: hand gesture are pretrained
            self.model = pickle.load(f)
        self.media_player = vlc.MediaPlayer() #creating vlc mediaplayer object
...
# Decrease volume
    ...
    def launch_cam(self):
        ...
        cap = cv2.VideoCapture(0) # 0 for comp cam and 1 for external cam
        ...
        with self.mp_hands.Hands(
            ...
            while cap.isOpened():
                ...
                image.flags.writeable = False # yolo another option
                ...
                try:
                    ...
                    # Make prediction
                    direction_gest = self.model.predict(X)[0] # pickle file fun
                ...
                if cv2.waitKey(10) & 0xFF == ord('q'):  # id we press q then cam off
                    break
